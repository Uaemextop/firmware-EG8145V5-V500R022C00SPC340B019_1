...
var_gCfgWord=""
type_word_v5="COMMON COMMON2 EUCOMMON EUCOMMON2 NACOMMON NACOMMON2 COMMONEBG COMMONEBG2 EUCOMMONEBG EUCOMMONEBG2 NACOMMONEBG NACOMMONEBG2 CLOSETELNET CLOSETELNETEBG CLOSETELNETEBG2 CHINA CHINAEBG COMMON4 COMMONEBG4 EUCOMMONEBG4"
...
HW_Script_SetDatToFile()
{
    ...
    if [ $var_support_secure_feature = 1 ]; then
		...
		#开启了特性开关的单板，定制时需要将OLT的CLI节点ModifyPWDFlag属性设置为1
