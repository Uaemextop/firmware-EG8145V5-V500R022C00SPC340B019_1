...
var_gCfgWord=""
type_word_v5="COMMON COMMON2 EUCOMMON EUCOMMON2 NACOMMON NACOMMON2 COMMONEBG COMMONEBG2 EUCOMMONEBG EUCOMMONEBG2 NACOMMONEBG NACOMMONEBG2 CLOSETELNET CLOSETELNETEBG CLOSETELNETEBG2 CHINA CHINAEBG COMMONEBG2WIFI5 EUCOMMONEBG25 EUCOMMONEBG4"
...
HW_Script_ReadDataFromFile()
{
	...
	then
		read -r var_ssid1 var_wpa1 var_ssid2 var_wpa2 var_webpwd< $var_customize_file
		if [ 0 -ne $? ]
		then
...
HW_Script_SetDatToFile()
{
	...
	HW_Script_Cfgtool_Set $var_default_ctree $var_node_web_pwd "Password" $var_webpwd
