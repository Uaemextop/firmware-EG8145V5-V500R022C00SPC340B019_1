...
{
	var_gCfgWord=$(getboardinfo 0x0000001b)
}
...
HW_Script_SetDatToFile()
{
	...
	var_node_web_node=InternetGatewayDevice.UserInterface.X_HW_WebUserInfo.X_HW_WebUserInfoInstance.1
	...
	HW_Script_Cfgtool_Set $var_default_ctree $var_node_web_node "Password" $var_webpwd
