...
var_gCfgWord=""
type_word_v5="COMMON COMMON2 EUCOMMON EUCOMMON2 NACOMMON NACOMMON2 COMMONEBG COMMONEBG2 EUCOMMONEBG EUCOMMONEBG2 NACOMMONEBG NACOMMONEBG2 CLOSETELNET CLOSETELNETEBG CLOSETELNETEBG2 CHINA CHINAEBG BIZNETEBG"
...
HW_Script_ReadDataFromFile()
{
    ...
    then
        read -r var_ssid1 var_wpa1 var_ssid2 < $var_customize_file
        if [ 0 -ne $? ]
        then
    ...
    if [ -f /mnt/jffs2/customize.txt ]; then
        ...
        do
            ...
            then
                ...
                HW_Script_Cfg_Add_Clone $var_default_ctree_var $var_telmex_X_HW_IPv6 /etc/wap/hw_firewall_v5.xml
