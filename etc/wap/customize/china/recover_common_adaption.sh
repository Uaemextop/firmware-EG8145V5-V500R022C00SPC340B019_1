...
echo $var_boardinfo_dup | xargs sed 's/obj.id = \"0x00000042\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000042\" ; obj.value = \"4\"/g' -i
echo $var_boardinfo_dup | xargs sed 's/obj.id = \"0x00000058\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000058\" ; obj.value = \"3\"/g' -i
