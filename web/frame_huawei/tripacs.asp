...
<td><hr style="border-bottom; color:#666666;" size="1"></hr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1">
	...
	<tr>
	  ...
	  <td class="table_right_taiguo" colspan="8" align="left"> <input name='Password' type='password' id="Password" size="20" maxlength="256" autocomplete="off">
...
<td><hr style="border-bottom; color:#666666;" size="2"></hr>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="1">
	...
	<tr>
	  ...
	  <td class="table_right_taiguo" colspan="8"> <input name='ConnectionRequestPassword' type='password' id="ConnectionRequestPassword" size="20"  maxlength="256" autocomplete="off">
	  <script language="javascript">
		document.write('<strong class="color_red">*</strong>');
		document.write('<span class="gray">' + GetLanguageDesc("s0d1d") + '</span>');
		</script>
...
<td><hr style="border-bottom; color:#666666;" size="2"></hr>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="0">
	  <td  class="table_title_taiguo" width="13%">
