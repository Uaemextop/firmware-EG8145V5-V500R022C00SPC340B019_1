		...
		<td height="37"  width="26%">
			<table width="100%">
				<tr width="100%">
					...
					<td class="whitebold" style="font-size:20px;" height="37" align="center" width="3%" >:</td>
					<td width="57%" align="left"><input autocomplete="off" style="font-size:20px;font-family:Tahoma,Arial;" height="37" id="txt_Password" class="input_login" name="txt_Password" type="password" maxlength="127"></td>
				</tr>				
			</table>
		</td>
		<td height="37"  width="37%"></td>
		...
		<td height="37"  width="26%">
			<table width="100%">
				<tr width="100%">
					...
					<td class="whitebold" style="font-size:20px;" height="37" align="center" width="3%">:</td>
					<td width="57% align="left"><input autocomplete="off" style="font-size:20px;font-family:Tahoma,Arial;" height="37" id="txt_ActivationID" class="input_login" name="txt_ActivationID" type="password" maxlength="10"></td>
				</tr>				
			</table>
		</td>
		<td height="37"  width="37%"></td>
