...
<script language="JavaScript" src="../../../resource/<%HW_WEB_Resource(ampdes.html, cfg_wlanguestwifi_language, cfg_wlancfgother_language, cfg_wlancfgdetail_language, vdf_wlan_basic_language);%>"></script>
