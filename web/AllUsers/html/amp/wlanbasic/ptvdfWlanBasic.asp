...
<script language="JavaScript" src="../../../resource/<%HW_WEB_Resource(ampdes.html, vdf_wlan_basic_language, cfg_wlancfgother_language, cfg_wlancfgbasic_language);%>"></script>
