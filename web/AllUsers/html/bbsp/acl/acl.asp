...
var securityInAccessFlag = '<%HW_WEB_GetFeatureSupport(FT_WAN_ACCESS_IN_SECURITY);%>';
...
{    
    ...
    if (CfgModeWord.toUpperCase() == 'TRIPLET2WIFI6') {
        ...
        if ((securityAccessFlag == '1') && (securityInAccessFlag == '0')) {
    ...
    {              
        ...
        if(ProductType != '2' && GetCfgMode().TRUE == "1")
        {
            ...
            if (((securityAccessFlag != '1') || (securityInAccessFlag == '1')) && (isWanAccess == '1')) {
    ...
    if (ProductType == '2') {
			...
			|| (GetCfgMode().TRUE == "1") || (CfgModeWord.toUpperCase() === 'TTNET2') || (CfgModeWord.toUpperCase() === 'DINFOTEK2'))
        {
            if (certificateFlag != 1) {
                ...
                if (((securityAccessFlag != '1') || (securityInAccessFlag == '1')) || (CfgModeWord.toUpperCase() === 'TTNET2') || (CfgModeWord.toUpperCase() === 'DINFOTEK2')) {
            ...
            if ((HideTelnet != '1') && (GetCfgMode().TRUE != "1" || (IsAdminUser() == true)) && (certificateFlag != 1)) {
                Form.addParameter('TELNETWifiEnable',getCheckVal('telnetwifi'));
            }

            if ((HideTelnet != '1') && ((SingleFlag != 1) && (GetCfgMode().TRUE != "1" || (IsAdminUser() == true))) && (certificateFlag != 1) &&
        ...
        var Form = new webSubmitForm();
             ...
             || (GetCfgMode().TRUE == "1"))
         {
             if (certificateFlag != 1) {
                 ...
                 if (((securityAccessFlag != '1') || (securityInAccessFlag == '1'))) {
             ...
             if ((HTTPPortFlag == 1) && ((securityAccessFlag != '1') || (securityInAccessFlag == '1'))) {
...
<form id="lan_table" style="display:none;"> 
    ...
    <table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg">
        ...
        <script>
            if ((CfgModeWord.toUpperCase() === 'CNT2') || (CfgModeWord.toUpperCase() === 'CNT')) {
                document.write("\<li id=\"httplan\"  RealType=\"CheckBox\"   DescRef=\"bbsp_table_lanhttps\"  RemarkRef=\"Empty\"  ErrorMsgRef=\"Empty\"    Require=\"FALSE\"    BindField=\"x.HTTPLanEnable\"  InitValue=\"Empty\" \/\> ");
            } else {
                document.write("\<li id=\"httplan\"  RealType=\"CheckBox\"   DescRef=\"bbsp_table_lanhttp\"  RemarkRef=\"Empty\"  ErrorMsgRef=\"Empty\"    Require=\"FALSE\"    BindField=\"x.HTTPLanEnable\"  InitValue=\"Empty\" \/\> ");
            }
...
<div class="func_spread"></div>
    ...
    <table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg">
        ...
        <script>
            if ((CfgModeWord.toUpperCase() === 'CNT2') || (CfgModeWord.toUpperCase() === 'CNT')) {
                document.write("\<li id=\"httpwan\"  RealType=\"CheckBox\"   DescRef=\"bbsp_table_wanhttps\"  RemarkRef=\"Empty\"  ErrorMsgRef=\"Empty\"    Require=\"FALSE\"    BindField=\"x.HTTPLanEnable\"  InitValue=\"Empty\" ClickFuncApp=\"onclick=OnDisplayhttp\" \/\> ");
            } else {
                document.write("\<li id=\"httpwan\"  RealType=\"CheckBox\"   DescRef=\"bbsp_table_wanhttp\"  RemarkRef=\"Empty\"  ErrorMsgRef=\"Empty\"    Require=\"FALSE\"    BindField=\"x.HTTPLanEnable\"  InitValue=\"Empty\" ClickFuncApp=\"onclick=OnDisplayhttp\" \/\> ");
            }
        </script>
...
<div id="httpport" style="display:none;">
    <div class="title_spread"></div>
    <div class="func_title">HTTP Port Management</div>
    <form id="lanhttp" name="lanhttp">
        ...
        <tr>
            <td class='width_per35'></td>
            <td class="table_submit pad_left5p">
                <button id="btnhttpport" type="button" onclick="lanhttpConfig();" class="ApplyButtoncss buttonwidth_100px" ><script>document.write(acl_language['s1005']);</script></button>
                <button id="btnhttpportCancel" type="button" onclick="lanhttpcancelconfig();" class="CancleButtonCss buttonwidth_100px" ><script>document.write(acl_language['s1006']);</script></button>
            </td>
        </tr>
        </table>
    </form>
...
<div class="title_spread"></div>
<div class="func_title">HTTPs Port Management</div>
<form id="wanhttps" name="wanhttps">
    ...
    <tr>
        <td class='width_per35'></td>
        <td class="table_submit pad_left5p">
            <button id="btnhttpsport"  type="button" onclick="lanhttpsConfig();" class="ApplyButtoncss buttonwidth_100px" ><script>document.write(acl_language['s1005']);</script></button>
            <button id="btnhttpsportCancel" type="button" onclick="lanhttpscancelconfig();" class="CancleButtonCss buttonwidth_100px" ><script>document.write(acl_language['s1006']);</script></button>
        </td>
    </tr>
    </table>
</form>
