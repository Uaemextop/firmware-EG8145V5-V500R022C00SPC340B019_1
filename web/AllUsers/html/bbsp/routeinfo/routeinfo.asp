...
<script language="JavaScript" type="text/javascript">
	HWCreatePageHeadInfo("routeinfotitle", GetDescFormArrayById(routeinfo_language, "bbsp_mune"), GetDescFormArrayById(routeinfo_language, "bbsp_routeinfo_title"), false);
</script> 
