...
<script language="JavaScript" type="text/javascript">
	HWCreatePageHeadInfo("ipv4dynamicroutetitle", GetDescFormArrayById(droute_language, "bbsp_mune"), GetDescFormArrayById(droute_language, "bbsp_title_prompt"), false);
</script> 
