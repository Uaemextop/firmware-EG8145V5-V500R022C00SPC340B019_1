...
function LoadFrame() 
{
    ...
    if ((cfgMode.toUpperCase() == "GDCMCC_RMS") && (ErrCode == "0xf7104022")) {
        document.getElementById('errorImg').style = "display:none;";
        document.getElementById('errorMsg').innerHTML = GetLanguageDesc("s0xf7104022");
    }
}
 ...
 <table width="100%" height="10%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="13%" align="center"><img id="errorImg" src="/images/error.gif" width="48" height="48" /></td>
                <td width="87%" id="errorMsg">
                <script language="JavaScript" type="text/javascript">
