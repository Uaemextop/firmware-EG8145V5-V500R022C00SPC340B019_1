...
function uploadCert()
{
	...
	top.previousPage = '/html/ssmp/accoutcfg/tripletsingleadmin.asp';
...
function AddSubmitImportcert()
{
	...
	Form.setAction('complex.cgi?x=InternetGatewayDevice.UserInterface.X_HW_WebSslInfo'
				   + '&RequestFile=html/ssmp/accoutcfg/tripletsingleadmin.asp');
...
function SetCertificateInfo()
{
	...
	Form.addParameter('x.X_HW_Token', getValue('onttoken'));
	Form.setAction('set.cgi?x=InternetGatewayDevice.UserInterface.X_HW_WebSslInfo&RequestFile=html/ssmp/accoutcfg/tripletsingleadmin.asp');
	Form.submit();
}
...
if(1 == IsSurportWebsslPage)
{
	HWCreatePageHeadInfo("tripletsingleadmin", GetDescFormArrayById(AccountLgeDes, "s0102"), GetDescFormArrayById(AccountLgeDes, "s0f07b"), false);
}
else
{
	HWCreatePageHeadInfo("tripletsingleadmin", GetDescFormArrayById(AccountLgeDes, "s0102"), GetDescFormArrayById(AccountLgeDes, "s0f07a"), false);
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg">
  ...
  <td class="table_right_pwd">
	<script language="JavaScript" type="text/javascript">document.write(htmlencode(supUserName));</script>

  </td>

  <tr id="TroldPassword">
  <td class="table_title_pwd width_per60" BindText="s0f13"></td>
  <td class="table_right_pwd"><input name='oldPassword' type="password" id="oldPassword" size="15" autocomplete="off"></td>
  </tr>

  </tr>
  <tr>
  <td class="table_title_pwd width_per60" BindText="s0f09"></td>
  <td class="table_right_pwd"><input name='newPassword' type="password" id="newPassword" size="15" autocomplete="off"></td>
  </tr>
  <tr>
...
<div class="func_spread"></div>
<form action="websslcert.cgi?RequestFile=html/ssmp/accoutcfg/tripletsingleadmin.asp" method="post" enctype="multipart/form-data" name="fr_uploadImage" id="fr_uploadImage">
  <div>
