...
function uploadCert()
{
	...
	top.previousPage = '/html/ssmp/accoutcfg/indosataccountadmin.asp';
...
function AddSubmitImportcert()
{
	...
	Form.setAction('complex.cgi?x=InternetGatewayDevice.UserInterface.X_HW_WebSslInfo'
				   + '&RequestFile=html/ssmp/accoutcfg/indosataccountadmin.asp');
...
function SetCertificateInfo()
{
	...
	Form.addParameter('x.X_HW_Token', getValue('onttoken'));
	Form.setAction('set.cgi?x=InternetGatewayDevice.UserInterface.X_HW_WebSslInfo&RequestFile=html/ssmp/accoutcfg/indosataccountadmin.asp');
	Form.submit();
}
...
function SubmitPwd()
{
    ...
    $.ajax({
         ...
         cache : false,
         data : parainfo,
         url : "setajax.cgi?x=InternetGatewayDevice.UserInterface.X_HW_WebUserInfo." + InstNo + "&RequestFile=html/ssmp/accoutcfg/indosataccountadmin.asp",
         success : function(data) {
...
if(1 == IsSurportWebsslPage)
{
	HWCreatePageHeadInfo("indosataccountadmin", GetDescFormArrayById(AccountLgeDes, "s0102"), GetDescFormArrayById(AccountLgeDes, "s0f07b"), false);
}
else
{
	HWCreatePageHeadInfo("indosataccountadmin", GetDescFormArrayById(AccountLgeDes, "s0102"), GetDescFormArrayById(AccountLgeDes, "s0f07a"), false);
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg">
  ...
  <td class="table_right_pwd">
	<select name='usernameinfo' size="1" id="usernameinfo" style="width:100px"  onchange="ShowOldArea(this.value)">
		<option value="0"> <script language="JavaScript" type="text/javascript">document.write(htmlencode(sptUserName));</script></option>
		<option value="1"> <script language="JavaScript" type="text/javascript">document.write(htmlencode(supUserName));</script></option>
	</select>
  </td>

  <tr id="TroldPassword" style="display:none">
  <td class="table_title_pwd width_per60" BindText="s0f13"></td>
  <td class="table_right_pwd"><input name='oldPassword' type="password" autocomplete="off" id="oldPassword" size="15"></td>
  </tr>

  </tr>
  <tr>
  <td class="table_title_pwd width_per60" BindText="s0f09"></td>
  <td class="table_right_pwd"><input name='newPassword' type="password" autocomplete="off" id="newPassword" size="15"></td>
  </tr>
  <tr>
  <td class="table_title_pwd width_per60" BindText="s0f0b"></td>
  <td class="table_right_pwd"><input name='cfmPassword' type='password' id="cfmPassword" size="15" autocomplete="off"></td>
  </tr>
  </table>  </td>
...
<div class="func_spread"></div>
<form action="websslcert.cgi?RequestFile=html/ssmp/accoutcfg/indosataccountadmin.asp" method="post" enctype="multipart/form-data" name="fr_uploadImage" id="fr_uploadImage">
  <div>
