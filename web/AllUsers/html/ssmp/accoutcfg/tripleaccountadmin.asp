...
function CheckPwdIsComplex(str)
{
	...
	if (!CompareString(str,supUserName) )
	{
		return false;
	}
...
function CheckParameter()
{
	...
	if (cfmPassword.value != newPassword.value)
	{
		...
		async : false,
		cache : false,
		url : "../common/CheckTripletPwd.asp?&1=1",
...
function SubmitPwd()
{
    ...
    $.ajax({
         ...
         cache : false,
         data : parainfo,
         url : "setajax.cgi?x=InternetGatewayDevice.UserInterface.X_HW_WebUserInfo." + curInstNo + "&RequestFile=html/ssmp/accoutcfg/tripleaccountadmin.asp",
         success : function(data) {
                ...
                if (ResultInfo.result == 0) {
                    ...
                    if (errorcode == 0xf7200119) {
                        ...
                        AlertEx("The password of the user was changed failed.");
                    }
                }
         },
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg"> 
  ...
  <td class="table_right_pwd"><input name='oldPassword' type="password" autocomplete="off" id="oldPassword" size="15" autocomplete="off"></td>
  </tr>
  
  </tr>
  <tr> 
  <td class="table_title_pwd width_per60" BindText="s0f09"></td>
  <td class="table_right_pwd"><input name='newPassword' type="password" autocomplete="off" id="newPassword" size="15" autocomplete="off"></td> 
  </tr>
  <tr> 
