...
var isUnicom = "<%HW_WEB_GetFeatureSupport(HW_SSMP_FEATURE_MNGT_UNICOM);%>" == 1;
...
if ((isFirst8VisibleChar(sn) == true) && (jiuzhouFlag != '1')) 
{
...
if (isUnicom && permissionIdentifier != 0) {
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg" id="Tabledeviceinfo">
  <tr  id="tr2" name="tr2"> 
    <td class="table_title" width="20%" align="left" id="td31_1" name="td31_1" >运营商:&nbsp;</td> 
    <td class="table_right" width="80%" id="td31_2" name="td31_2"> 
  ...
  <tr  id="tr3" name="tr3"> 
    <td class="table_title" width="20%" align="left" id="td3_1" name="td3_1" >设备型号:&nbsp;</td> 
    <td class="table_right" width="80%" id="td3_2" name="td3_2"> 
		<script language="javascript">
		if (deviceInfo != null)
		{
			document.write(htmlencode(devicename));
		}
		else
		{
			document.write('');
...
<script language="javascript">
  ...
  <tr id="tr5" name="tr5"> 
    <td class="table_title" width="20%" align="left" id="td5_1" name="td5_1">设备标识号:&nbsp;</td> 
    <td class="table_right" align="left" width="80%" id="td5_2" name="td5_2"> <script language="javascript">
	...
	{
		document.write(htmlencode(deviceInfo.Mac));
	}
	else
	{
		document.write(htmlencode(SN));
  ...
  <tr id="tr50" name="tr50"> 
    <td class="table_title"  id="td50_1"> 
    <script language="javascript">
	if (ontPonMode.toUpperCase() == 'GPON')
	{
		document.write("SN:&nbsp;");
...
<script language="javascript">
  ...
  <tr  id="tr7" name="tr7"> 
	...
	if ('GDCU' == CfgMode.toUpperCase())
	{
		...
		document.write(htmlencode(VersionAndTime));
	}
	else
	{
...
<script type="text/javascript" language="javascript">
	if(ontPonMode.toUpperCase() == 'GPON' || ontPonMode.toUpperCase() == 'EPON')
	{
      ...
      <tr id="tr13" name="tr13" style="display:none;"> 
    <td class="table_title" width="20%" align="left" id="td13_1" name="td13_1">设备标识号:&nbsp;</td> 
    <td class="table_right" width="80%" id="td13_2" name="td13_2"> <script language="javascript">
		document.write(htmlencode(deviceTag));
	</script> </td> 
  </tr>
   <tr id="tr14" name="tr14"> 
    <td class="table_title" width="20%" align="left" id="td13_1" name="td13_1">联通设备标识:&nbsp;</td> 
    <td class="table_right" width="80%" id="td13_2" name="td13_2"> <script language="javascript">
		document.write(htmlencode(deviceInfo.specsn));
	</script> </td> 
  </tr>
