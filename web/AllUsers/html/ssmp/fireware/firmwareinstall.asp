...
<script language="JavaScript" src="../../../resource/spanish/<%HW_WEB_CleanCache_Resource(ssmpdes.js);%>"></script>
...
<body class="mainbody" onLoad="LoadFrame();">
	...
	<form action="Firmwareupload.cgi?RequestFile=html/management/reset_install.asp&FileType=image" method="post" enctype="multipart/form-data" name="fr_uploadImage" id="fr_uploadImage">
		<table>
			<tr>
